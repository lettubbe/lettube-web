        ...
        <section className={styles.sectionWhite} ref={(el) => addToRefs(el, 0)}>
          <div className={styles.sectionContent}>
            <div className={styles.textContent}>
              ...
              <a href="https://lettube-apks.s3.eu-north-1.amazonaws.com/lettube-v1-production-13-06-2025.apk" download className={styles.ctaButton}>Try the beta app now</a>
            </div>
        ...
        <section className={styles.sectionFinal} ref={(el) => addToRefs(el, 2)}>
          <div className={styles.finalContent}>
            <div className={styles.finalTextContent}>
              ...
              <a href="https://lettube-apks.s3.eu-north-1.amazonaws.com/lettube-v1-production-13-06-2025.apk" download className={styles.finalCtaButton}>Try the beta app now</a>
            </div>
          </div>
